...
textAngular.directive("textAngular", ["$compile", "$window", "$document", "$rootScope", "$timeout", "taFixChrome", function (t, e, n, a, l, i) {
    ...
    a.textAngularOpts = o({
        toolbar: [
            ...
            ["bold", "italics", "underline", "ul", "ol", "redo", "undo", "clear"], ["justifyFull", "justifyLeft", "justifyCenter", "justifyRight"],
            ["html", "insertImage", "insertLink", "unlink", "embedVideo", "embedHTML"]
        ],
        classes: {
    ...
    a.textAngularTools = o({
        html: {
            display: "<button type='button-ta' ng-click='action()' ng-class='displayActiveToolClass(active)'>source</button>",
            action: function () {
                var t,
                    e = this;
        ...
        h1: {
            display: "<button type='button-ta' ng-click='action()' ng-class='displayActiveToolClass(active)'><b>H1</b></button>",
            action: function () {
        ...
        h2: {
            display: "<button type='button-ta' ng-click='action()' ng-class='displayActiveToolClass(active)'><b>H2</b></button>",
            action: function () {
        ...
        h3: {
            display: "<button type='button-ta' ng-click='action()' ng-class='displayActiveToolClass(active)'><b>H3</b></button>",
            action: function () {
        ...
        p: {
            display: "<button type='button-ta' ng-click='action()' ng-class='displayActiveToolClass(active)'><b>P</b></button>",
            action: function () {
        ...
        bold: {
            display: "<button type='button-ta' ng-click='action()' ng-class='displayActiveToolClass(active)'><b>B</b></button>",
            action: function () {
        ...
        justifyFull: {
            display: "<button type='button-ta' ng-click='action()' ng-class='displayActiveToolClass(active)'><i class='fa fa-align-justify'></i></button>",
            action: function () {
                return this.$parent.wrapSelection("justifyFull", null)
            },
            activeState: function () {
                return n[0].queryCommandState("justifyFull")
            }
        },
        justifyLeft: {
        ...
        italics: {
            display: "<button type='button-ta' ng-click='action()' ng-class='displayActiveToolClass(active)'><i><b>I</b></i></button>",
            action: function () {
        ...
        underline: {
            display: "<button type='button-ta' ng-click='action()' ng-class='displayActiveToolClass(active)'><u><b>U</b></u></button>",
            action: function () {
        ...
        embedVideo: {
            display: "<button type='button-ta' ng-click='action()' ng-class='displayActiveToolClass(active)'><i class='fa fa-film'></i></button>",
            action: function () {
                var t;
                t = prompt(
                    "Please enter an embed video URL to insert\n" +
                    "- Vimeo : https://player.vimeo.com/video/338592961\n" +
                    "- Daily Motion : https://www.dailymotion.com/embed/video/x79tao7",
                    "https://www.youtube.com/embed/fR3Ezf-UZDo"
                );
                if (t !== "" && t !== null) {
                    var html = "<iframe style=width:500px;height:300px;background-color:#a6a6a6 frameBorder=0 src=" + t + "></iframe>";
                    return this.$parent.wrapSelection("insertHTML", html)
                }
            }
        },
        embedHTML: {
            display: "<button type='button-ta' ng-click='action()' ng-class='displayActiveToolClass(active)'>embed</button>",
            action: function () {
                var t;
                t = prompt("Please enter embed HTML", "");
                if (t !== "" && t !== null) {
                    return this.$parent.wrapSelection("insertHTML", t)
                }
            }
        },
        insertLink: {
    ...
    return {
        ...
        link: function (e, o, s, r) {
            ...
            e.displayElements = {
                ...
                html: angular.element("<textarea ng-show='showHtml' ta-bind='html' ng-model='html' class='html-editor'></textarea>"),
